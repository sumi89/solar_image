...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 21 18:40:00 2019
...
######################################
#                                    #
#   IN THIS CODE, CHANNEL IS CREATED #
#                                    #
######################################
import keras
...
datagen=ImageDataGenerator(rescale=1./255, preprocessing_function = ch_making_func, validation_split=0.25)
train_generator=datagen.flow_from_dataframe(dataframe=pdf, directory = "None", color_mode= "rgb" , 
                                            x_col="filename", y_col=target_name, subset="training", class_mode="other", 
                                            target_size=input_shape[:2], batch_size=32)

valid_generator=datagen.flow_from_dataframe(dataframe=pdf, directory = "None", color_mode= "rgb" , 
                                            x_col="filename", y_col=target_name, subset="validation", class_mode="other", 
                                            target_size=input_shape[:2], batch_size=32)
...
model.add(Dense(6, kernel_initializer = he_normal(),activation='linear'))
